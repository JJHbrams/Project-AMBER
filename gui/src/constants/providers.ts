...
export const PROVIDERS: ProviderInfo[] = [
  ...
  },
  {
    ...
    defaultModel: "auto",
    logoChar: "✦",
    contextWindow: "model-dependent (agy models)",
    rateLimit: "account and model dependent",
    features: ["agy interactive and -p print mode", "--model selection", "MCP HTTP support", "PreToolUse policy hook"],
    quotaNote: "antigravity.google",
  },
  {
    id: "ollama",
    displayName: "Ollama",
